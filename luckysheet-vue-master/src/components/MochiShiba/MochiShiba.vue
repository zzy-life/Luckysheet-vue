    ...
    export default {
        ...
        computed: {
            ears: function () {
                let l = "l4";
                let r = "r4";
                if (this.leftEarTemp === "up") { l = "l1"; }
                else if (this.leftEarTemp === "down") { l = "l3"; }
                else if (this.leftEarTemp === "flat") { l = "l2"; }
                if (this.rightEarTemp === "up") { r = "r1"; }
                else if (this.rightEarTemp === "down") { r = "r3"; }
                else if (this.rightEarTemp === "flat") { r = "r2"; }
                return `/ ears ${l} ${r}`;
            },
            eyes: function () {
                if (this.leftEyeTemp === this.rightEyeTemp) {
                    return `/ eyes ${this.leftEyeTemp}`;
                } else {
                    return `/ eyes l${this.leftEyeTemp} r${this.rightEyeTemp}`;
                }
            },
            cheeks: function () {
                return this.blushTemp ? "/ blush" : "";
            },
            styleClass: function () {
                return `${this.sizesizeTemp} / ${this.moodsizeTemp} ${this.eyes} ${this.ears} ${this.cheeks}`;
            }
        },
        methods: {},
    }
